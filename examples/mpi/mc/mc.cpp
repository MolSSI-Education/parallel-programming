...
int main(int argc, char **argv) {
  ...
  *************************/
  ...
  for (int i_step=0; i_step<n_steps; i_step++) {
    ...
    double current_energy = get_particle_energy( coordinates, num_particles, box_length, i_particle, simulation_cutoff2 );
    ...
    double proposed_energy = get_particle_energy( coordinates, num_particles, box_length, i_particle, simulation_cutoff2 );
    total_energy_time += MPI_Wtime() - start_energy_time;
