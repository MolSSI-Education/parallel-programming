...
double time_red, time_force, time_neigh, time_total; // Timers
...
#pragma omp master
    {
      time_red += omp_get_wtime() - start_red;
...
#pragma omp parallel
    ...
    printf("times:  reduction=%.2fs  force=%.2fs  neigh=%.2fs  total=%.2fs\n", 
	   time_red, time_force, time_neigh, time_total);
